...
public class ProfilView extends BaseCardLayout {
    ...
    protected void findViews() {
        View.inflate(getContext(), R.layout.view_profil, this);
        ...
        txt_title.setText("Profil Sekolah");
        addView(txt_title, LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT);

        Button btweb = (Button)findViewById(R.id.web);
        btweb.setOnClickListener(new OnClickListener() {
            @Override
