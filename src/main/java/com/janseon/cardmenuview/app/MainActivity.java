...
import com.janseon.cardmenuview.view.ProfilView;
...
public class MainActivity extends BaseActivity implements OnItemClickListener  {
    ...
    private ProfilView mCreativeView;
...
//    private DramaView mDramaView;
    ...
    protected void findViews() {
        ...
        mCreativeView = (ProfilView) findViewById(R.id.view_creative);
...
//		}
        ...
        list.add(new Menu(R.drawable.icon_main_drama, "Informasi\nSekolah"));
        list.add(new Menu(R.drawable.icon_main_crowd, "Kegiatan\nSekolah"));
        list.add(new Menu(R.drawable.icon_main_sponsorship, "Daftar Hadir\nSiswa"));
        list.add(new Menu(R.drawable.icon_main_com_video, "Hasill Studi\nSiswa"));
        msgMenu = new Menu(R.drawable.icon_main_message, "Kontak\nSekolah");
        list.add(msgMenu);
...
//        txt_name.setText(userInfo.nickname);
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        switch (position) {
            case 0:
                Intent IntentUtil = new Intent(this, InfoSekolahActivity.class);
